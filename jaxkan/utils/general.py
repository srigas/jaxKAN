    ...
    """
        ...
        -----
            mu_old (jnp.array): first-order moments before extension
                shape (n_in*n_out, num_basis) or (n_out, n_in, num_basis)
            nu_old (jnp.array): second-order moments before extension
                shape (n_in*n_out, num_basis) or (n_out, n_in, num_basis)
            new shape (tuple): (n_in*n_out, new_num_basis) or (n_out, n_in, new_num_basis)
        
        Returns:
        --------
            mu_new (jnp.array): first-order moments after extension
                shape (n_in*n_out, new_num_basis) or (n_out, n_in, new_num_basis)
